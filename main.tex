...
\cventry{East Lansing, MI}{\textsc{Michigan State University}}{Undergraduate Research Assistant}{Summer 2018}{}
{
    \cvitem{Labs}{\textbf{Harada Lab}, \small{Department of Biomedical Engineering}, MSU}
    \cvitem{Mentor}{Dr. Masako Harada}
    \begin{itemize}
        \item Design primers with blast tools, and clone desired gener using Seamless Ligation Extract (SLiCE) method
    \end{itemize}
}
...
\subsection{Posters} 
{
    \begin{itemize}
        ...
        \item {\cvitem{Aug, 20}{\textbf{Mid-Michigan Symposium for Undergraduate Research Experiences (Mid-SURE)}, Ovarian torsion identification using machine learning.
...
\section{Service and Leadership}
{
    ...
    \cventry{East Lansing, MI}{Rural books cataloging}{Simbolei Project}{Sep 2017}{}
    {
        \begin{itemize}
            \item \cvitem{}{Helped in cataloging books to be sent to rural library in Kenya}
        \end{itemize}
    }
