...
{
    \cvitem{Project 2}{MicroGenomeR: An R data package for standardizing and integrating bacterial data from diverse datasource}
    \begin{itemize} 
...
\section{Service and Leadership}
{
    ...
    {
        \begin{itemize}
            \item \cvitem{}{Donated uniforms to 11 students from orphaned or low-income families, improving access to education}
        \end{itemize}
    }
    ...
    {
        \begin{itemize}
            \item \cvitem{}{Guided others tutors to ensure smooth running of the tutoring center}
    ...
    {
        \begin{itemize}
            \item \cvitem{}{Guided a group of 10 international students in their first week of enrolling at MSU}
        \end{itemize}
    }
    ...
    {
        \begin{itemize}
            \item \cvitem{}{Helped in community need assesment in Kokwa Island with patternship with Friends of Kenya Schools and Wildlife (FKSW)}
        \end{itemize}
    }
